  ...
  <div class="app-container">
    <div class="verify-container">
      <div class="verify-card">
        ...
        <div class="card">
          <h2>Необходима е верификация на email</h2>
          <p class="text-secondary" style="margin-top: var(--space-4);">
            Изпратихме верификационен линк на адрес<br>
            <strong><?= htmlspecialchars($email) ?></strong>
          </p>
          <p class="text-secondary">
            Моля, проверете вашата електронна поща и кликнете върху линка, за да активирате акаунта си.
          </p>
